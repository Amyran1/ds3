"""No-op harness fixture for perf_bounty integration tests.

Copies frozen predictions unchanged (equivalence passes) but reports
wall time only 5% faster than the oracle (speedup < 10% → outcome=noise).
"""
...
def run_harness(
    ...
    **_kwargs: Any,
    ...
    """Copy frozen predictions without modification; report 5% speedup."""
    ...
    total_seconds = oracle_wall_seconds * 0.95
